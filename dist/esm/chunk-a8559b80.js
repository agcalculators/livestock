...
const gestationOptionLabels = getstationOptions.reduce((obj, current) => {
  obj[current.value] = current.text;
  return obj;
}, {});

export { gestationOptions as a, gestationOptionLabels as b, damAgeOptions as c, damAgeOptionLabels as d, genderOptions as e, genderOptionLabels as f };
