import calculateBirthingPercentage from '../calculators/birthing-percentage';
...
export default {
    ...
    category: 'livestock',
    inputs: {
        numberBorn: { type: 'number', label: 'Number Offspring Born', validators: ['required', 'number', 'min'], params: { min: 0} },
    ...
    outputs: {
        birthingPercentage: { type: 'number', label: 'Birthing Percentage', units: '%' },
        calculated: { type: 'date', label: 'Calculated Date'}
    },
    calculator: calculateBirthingPercentage,
    messages: {
        numberBorn: { required: 'Number of offspring born is required', number: 'Number of offspring born must be a number', min: 'Number of offspring born should be zero or greater'},
