...
const pregRates = {
    [2]: .85, [3]: .90, [4]: .95, [5]: .95, [6]: .95, [7]: .95, [8]: .95, [9]: .90, [10]: .90, [11]: .90
}

export default function({herdSize, replacementRate}) {
    let errors = {
        herdSize: validate(herdSize, ['required', 'number', 'min'], { min: 1}),
        replacementRate: validate(replacementRate, ['required', 'number', 'min'], { min: 0})
    };
